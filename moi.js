var rule = {
    ...
    // 静态分类写法：class_name 和 class_url 用 & 分隔一一对应
    ...
    搜索: '.excerpts-wrapper article;h2&&Text;img&&data-src;.post-view&&Text;a&&href',

    // 二级详情
    二级: '.article-title&&Text;body > script&&Html&&shareimage\\s*:\\s*\'([^\']+)\';.article-tags a&&Text;body',
